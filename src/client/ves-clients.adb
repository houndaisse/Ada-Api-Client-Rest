...
package body Ves.Clients is
   ...
   procedure Receive_Event_Using_POST
      (Client : in out Client_Type;
       ...
       --View_Name1 : in Swagger.UString;
       --View_Name2 : in Swagger.UString;
       --View_Name3 : in Swagger.Long;
       --View_Name4 : in Swagger.UString;
       Result : out Swagger.UString) is
      URI   : Swagger.Clients.URI_Type;
   ...
   begin 
      ...
      --Req.Stream.Write_Entity ("commonEvenHeader", View_Name);
      --Req.Stream.Write_Entity ("eventName", View_Name1);
      --Req.Stream.Write_Entity ("domain", View_Name2);
      --Req.Stream.Write_Long_Entity ("eventType", View_Name3);
      --Req.Stream.Write_Entity ("SourceName", View_Name4);
